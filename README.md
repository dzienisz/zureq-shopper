...
- **Build sharing** exports a plan as Markdown or a link and imports shared plans without candidate search results.
  Shared links use a stable GitHub URL; recipients paste them into Build → Import a shared build.
