...
zip -q "$ZIP" \
  manifest.json background.js zureq.js builds.js assistant.js optimizer.js autocompare.js pagescan.js content.js watchlist.js \
...
listing="$(unzip -l "$ZIP")"
echo "Verifying $ZIP:"
for file in manifest.json background.js optimizer.js autocompare.js watchlist.js sidepanel.html LICENSE; do
